...
class MySQLService {
    ...
    configuration() {
        return {
            host: ConfigProvider_1.default.host(),
            user: ConfigProvider_1.default.user(),
            password: ConfigProvider_1.default.password(),
            database: ConfigProvider_1.default.database()
        };
    }
}
